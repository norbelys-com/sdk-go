...
// EmailVariantContent struct for EmailVariantContent
type EmailVariantContent struct {
	AiEmailVariantContent *AiEmailVariantContent
	StaticEmailVariantContent *StaticEmailVariantContent
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *EmailVariantContent) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(EmailVariantContent)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *EmailVariantContent) MarshalJSON() ([]byte, error) {
...
type NullableEmailVariantContent struct {
	value *EmailVariantContent
	isSet bool
}

func (v NullableEmailVariantContent) Get() *EmailVariantContent {
	return v.value
}

func (v *NullableEmailVariantContent) Set(val *EmailVariantContent) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailVariantContent) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailVariantContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailVariantContent(val *EmailVariantContent) *NullableEmailVariantContent {
	return &NullableEmailVariantContent{value: val, isSet: true}
}

func (v NullableEmailVariantContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailVariantContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
