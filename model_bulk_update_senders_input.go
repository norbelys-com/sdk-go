...
// checks if the BulkUpdateSendersInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkUpdateSendersInput{}

// BulkUpdateSendersInput struct for BulkUpdateSendersInput
type BulkUpdateSendersInput struct {
	// The mailbox ids to update (1–200 per call).
	Ids []string `json:"ids"`
	Patch BulkUpdateSenderPatch `json:"patch"`
}

type _BulkUpdateSendersInput BulkUpdateSendersInput
...
func (o BulkUpdateSendersInput) MarshalJSON() ([]byte, error) {
...
func (o BulkUpdateSendersInput) ToMap() (map[string]interface{}, error) {
...
func (o *BulkUpdateSendersInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkUpdateSendersInput := _BulkUpdateSendersInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBulkUpdateSendersInput)

	if err != nil {
		return err
	}

	*o = BulkUpdateSendersInput(varBulkUpdateSendersInput)

	return err
}

type NullableBulkUpdateSendersInput struct {
	value *BulkUpdateSendersInput
	isSet bool
}

func (v NullableBulkUpdateSendersInput) Get() *BulkUpdateSendersInput {
	return v.value
}

func (v *NullableBulkUpdateSendersInput) Set(val *BulkUpdateSendersInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkUpdateSendersInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkUpdateSendersInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkUpdateSendersInput(val *BulkUpdateSendersInput) *NullableBulkUpdateSendersInput {
	return &NullableBulkUpdateSendersInput{value: val, isSet: true}
}

func (v NullableBulkUpdateSendersInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkUpdateSendersInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
