...
// checks if the ImapConnectionUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImapConnectionUpdate{}

// ImapConnectionUpdate IMAP server settings to update.
type ImapConnectionUpdate struct {
	// The server hostname.
...
func (o ImapConnectionUpdate) MarshalJSON() ([]byte, error) {
...
func (o ImapConnectionUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableImapConnectionUpdate struct {
	value *ImapConnectionUpdate
	isSet bool
}

func (v NullableImapConnectionUpdate) Get() *ImapConnectionUpdate {
	return v.value
}

func (v *NullableImapConnectionUpdate) Set(val *ImapConnectionUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableImapConnectionUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableImapConnectionUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImapConnectionUpdate(val *ImapConnectionUpdate) *NullableImapConnectionUpdate {
	return &NullableImapConnectionUpdate{value: val, isSet: true}
}

func (v NullableImapConnectionUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImapConnectionUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
