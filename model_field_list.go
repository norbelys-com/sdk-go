...
// checks if the FieldList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FieldList{}

// FieldList struct for FieldList
type FieldList struct {
	// The org's custom fields, in display order.
...
func (o FieldList) ToMap() (map[string]interface{}, error) {
...
func (o *FieldList) UnmarshalJSON(data []byte) (err error) {
	...
	varFieldList := _FieldList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFieldList)

	if err != nil {
		return err
	}

	*o = FieldList(varFieldList)

	return err
}

type NullableFieldList struct {
	value *FieldList
	isSet bool
}

func (v NullableFieldList) Get() *FieldList {
	return v.value
}

func (v *NullableFieldList) Set(val *FieldList) {
	v.value = val
	v.isSet = true
}

func (v NullableFieldList) IsSet() bool {
	return v.isSet
}

func (v *NullableFieldList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFieldList(val *FieldList) *NullableFieldList {
	return &NullableFieldList{value: val, isSet: true}
}

func (v NullableFieldList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFieldList) UnmarshalJSON(src []byte) error {
	v.isSet = true
