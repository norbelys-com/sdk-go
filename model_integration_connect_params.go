...
// checks if the IntegrationConnectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationConnectParams{}

// IntegrationConnectParams struct for IntegrationConnectParams
type IntegrationConnectParams struct {
	// The provider to connect.
	Provider IntegrationProvider `json:"provider"`
}

type _IntegrationConnectParams IntegrationConnectParams

// NewIntegrationConnectParams instantiates a new IntegrationConnectParams object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIntegrationConnectParams(provider IntegrationProvider) *IntegrationConnectParams {
	this := IntegrationConnectParams{}
	this.Provider = provider
	return &this
}

// NewIntegrationConnectParamsWithDefaults instantiates a new IntegrationConnectParams object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewIntegrationConnectParamsWithDefaults() *IntegrationConnectParams {
	this := IntegrationConnectParams{}
	return &this
}

// GetProvider returns the Provider field value
func (o *IntegrationConnectParams) GetProvider() IntegrationProvider {
	if o == nil {
...
func (o *IntegrationConnectParams) GetProviderOk() (*IntegrationProvider, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IntegrationConnectParams) SetProvider(v IntegrationProvider) {
	o.Provider = v
}

func (o IntegrationConnectParams) MarshalJSON() ([]byte, error) {
...
func (o IntegrationConnectParams) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["provider"] = o.Provider
	return toSerialize, nil
}

func (o *IntegrationConnectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationConnectParams := _IntegrationConnectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIntegrationConnectParams)

	if err != nil {
		return err
	}

	*o = IntegrationConnectParams(varIntegrationConnectParams)

	return err
}

type NullableIntegrationConnectParams struct {
	value *IntegrationConnectParams
	isSet bool
}

func (v NullableIntegrationConnectParams) Get() *IntegrationConnectParams {
	return v.value
}

func (v *NullableIntegrationConnectParams) Set(val *IntegrationConnectParams) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationConnectParams) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationConnectParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationConnectParams(val *IntegrationConnectParams) *NullableIntegrationConnectParams {
	return &NullableIntegrationConnectParams{value: val, isSet: true}
}

func (v NullableIntegrationConnectParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationConnectParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
