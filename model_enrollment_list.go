...
type EnrollmentList struct {
	...
	Counts EnrollmentCounts `json:"counts"`
}

type _EnrollmentList EnrollmentList
...
func (o *EnrollmentList) UnmarshalJSON(data []byte) (err error) {
	...
	varEnrollmentList := _EnrollmentList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEnrollmentList)

	if err != nil {
		return err
	}

	*o = EnrollmentList(varEnrollmentList)
