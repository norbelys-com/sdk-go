...
// checks if the OrganizationBouncePolicyParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationBouncePolicyParams{}

// OrganizationBouncePolicyParams Bounce-handling policy to update.
type OrganizationBouncePolicyParams struct {
...
func NewOrganizationBouncePolicyParams() *OrganizationBouncePolicyParams {
	this := OrganizationBouncePolicyParams{}
	return &this
}
...
func (o OrganizationBouncePolicyParams) MarshalJSON() ([]byte, error) {
...
func (o OrganizationBouncePolicyParams) ToMap() (map[string]interface{}, error) {
...
type NullableOrganizationBouncePolicyParams struct {
	value *OrganizationBouncePolicyParams
	isSet bool
}

func (v NullableOrganizationBouncePolicyParams) Get() *OrganizationBouncePolicyParams {
	return v.value
}

func (v *NullableOrganizationBouncePolicyParams) Set(val *OrganizationBouncePolicyParams) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationBouncePolicyParams) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationBouncePolicyParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationBouncePolicyParams(val *OrganizationBouncePolicyParams) *NullableOrganizationBouncePolicyParams {
	return &NullableOrganizationBouncePolicyParams{value: val, isSet: true}
}

func (v NullableOrganizationBouncePolicyParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationBouncePolicyParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
