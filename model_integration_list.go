...
// checks if the IntegrationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationList{}

// IntegrationList struct for IntegrationList
...
type _IntegrationList IntegrationList
...
func (o IntegrationList) MarshalJSON() ([]byte, error) {
...
func (o IntegrationList) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationList) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationList := _IntegrationList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIntegrationList)

	if err != nil {
		return err
	}

	*o = IntegrationList(varIntegrationList)

	return err
}

type NullableIntegrationList struct {
	value *IntegrationList
	isSet bool
}

func (v NullableIntegrationList) Get() *IntegrationList {
	return v.value
}

func (v *NullableIntegrationList) Set(val *IntegrationList) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationList) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationList(val *IntegrationList) *NullableIntegrationList {
	return &NullableIntegrationList{value: val, isSet: true}
}

func (v NullableIntegrationList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationList) UnmarshalJSON(src []byte) error {
	v.isSet = true
