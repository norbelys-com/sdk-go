...
// checks if the AddProgramSenderParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddProgramSenderParams{}

// AddProgramSenderParams struct for AddProgramSenderParams
type AddProgramSenderParams struct {
	// The sender to attach.
	SenderId string `json:"senderId"`
}

type _AddProgramSenderParams AddProgramSenderParams

// NewAddProgramSenderParams instantiates a new AddProgramSenderParams object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAddProgramSenderParams(senderId string) *AddProgramSenderParams {
	this := AddProgramSenderParams{}
	this.SenderId = senderId
	return &this
}

// NewAddProgramSenderParamsWithDefaults instantiates a new AddProgramSenderParams object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAddProgramSenderParamsWithDefaults() *AddProgramSenderParams {
	this := AddProgramSenderParams{}
	return &this
}

// GetSenderId returns the SenderId field value
func (o *AddProgramSenderParams) GetSenderId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AddProgramSenderParams) GetSenderIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AddProgramSenderParams) SetSenderId(v string) {
	o.SenderId = v
}

func (o AddProgramSenderParams) MarshalJSON() ([]byte, error) {
...
func (o AddProgramSenderParams) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["senderId"] = o.SenderId
	return toSerialize, nil
}

func (o *AddProgramSenderParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAddProgramSenderParams := _AddProgramSenderParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddProgramSenderParams)

	if err != nil {
		return err
	}

	*o = AddProgramSenderParams(varAddProgramSenderParams)

	return err
}

type NullableAddProgramSenderParams struct {
	value *AddProgramSenderParams
	isSet bool
}

func (v NullableAddProgramSenderParams) Get() *AddProgramSenderParams {
	return v.value
}

func (v *NullableAddProgramSenderParams) Set(val *AddProgramSenderParams) {
	v.value = val
	v.isSet = true
}

func (v NullableAddProgramSenderParams) IsSet() bool {
	return v.isSet
}

func (v *NullableAddProgramSenderParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddProgramSenderParams(val *AddProgramSenderParams) *NullableAddProgramSenderParams {
	return &NullableAddProgramSenderParams{value: val, isSet: true}
}

func (v NullableAddProgramSenderParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddProgramSenderParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
