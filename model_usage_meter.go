...
// UsageMeter Live campaigns (`active` + `paused`, not archived). Drafts are free.
...
func (o *UsageMeter) UnmarshalJSON(data []byte) (err error) {
	...
	varUsageMeter := _UsageMeter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUsageMeter)

	if err != nil {
		return err
	}

	*o = UsageMeter(varUsageMeter)
