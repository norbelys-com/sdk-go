...
type AudienceAttributeCondition struct {
	...
	Value NullableAudienceConditionValue `json:"value,omitempty"`
}
...
func (o *AudienceAttributeCondition) GetValue() AudienceConditionValue {
	if o == nil || IsNil(o.Value.Get()) {
		var ret AudienceConditionValue
		return ret
	}
	return *o.Value.Get()
}
...
// SetValue gets a reference to the given NullableAudienceConditionValue and assigns it to the Value field.
