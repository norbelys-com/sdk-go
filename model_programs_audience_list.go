...
// checks if the ProgramsAudienceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProgramsAudienceList{}

// ProgramsAudienceList A page of programs audience results.
type ProgramsAudienceList struct {
	// The page of results, newest first.
	Data []AudienceSource `json:"data"`
...
type _ProgramsAudienceList ProgramsAudienceList
...
func (o ProgramsAudienceList) MarshalJSON() ([]byte, error) {
...
func (o ProgramsAudienceList) ToMap() (map[string]interface{}, error) {
...
func (o *ProgramsAudienceList) UnmarshalJSON(data []byte) (err error) {
	...
	varProgramsAudienceList := _ProgramsAudienceList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProgramsAudienceList)

	if err != nil {
		return err
	}

	*o = ProgramsAudienceList(varProgramsAudienceList)

	return err
}

type NullableProgramsAudienceList struct {
	value *ProgramsAudienceList
	isSet bool
}

func (v NullableProgramsAudienceList) Get() *ProgramsAudienceList {
	return v.value
}

func (v *NullableProgramsAudienceList) Set(val *ProgramsAudienceList) {
	v.value = val
	v.isSet = true
}

func (v NullableProgramsAudienceList) IsSet() bool {
	return v.isSet
}

func (v *NullableProgramsAudienceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProgramsAudienceList(val *ProgramsAudienceList) *NullableProgramsAudienceList {
	return &NullableProgramsAudienceList{value: val, isSet: true}
}

func (v NullableProgramsAudienceList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProgramsAudienceList) UnmarshalJSON(src []byte) error {
	v.isSet = true
