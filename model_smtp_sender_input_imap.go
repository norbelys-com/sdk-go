...
// checks if the SmtpSenderInputImap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmtpSenderInputImap{}

// SmtpSenderInputImap IMAP server replies and warmup mail are read from (reuses the SMTP credentials).
type SmtpSenderInputImap struct {
	// The server hostname.
...
type _SmtpSenderInputImap SmtpSenderInputImap
...
func (o SmtpSenderInputImap) MarshalJSON() ([]byte, error) {
...
func (o SmtpSenderInputImap) ToMap() (map[string]interface{}, error) {
...
func (o *SmtpSenderInputImap) UnmarshalJSON(data []byte) (err error) {
	...
	varSmtpSenderInputImap := _SmtpSenderInputImap{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSmtpSenderInputImap)

	if err != nil {
		return err
	}

	*o = SmtpSenderInputImap(varSmtpSenderInputImap)

	return err
}

type NullableSmtpSenderInputImap struct {
	value *SmtpSenderInputImap
	isSet bool
}

func (v NullableSmtpSenderInputImap) Get() *SmtpSenderInputImap {
	return v.value
}

func (v *NullableSmtpSenderInputImap) Set(val *SmtpSenderInputImap) {
	v.value = val
	v.isSet = true
}

func (v NullableSmtpSenderInputImap) IsSet() bool {
	return v.isSet
}

func (v *NullableSmtpSenderInputImap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmtpSenderInputImap(val *SmtpSenderInputImap) *NullableSmtpSenderInputImap {
	return &NullableSmtpSenderInputImap{value: val, isSet: true}
}

func (v NullableSmtpSenderInputImap) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmtpSenderInputImap) UnmarshalJSON(src []byte) error {
	v.isSet = true
