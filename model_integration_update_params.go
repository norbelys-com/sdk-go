...
// checks if the IntegrationUpdateParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationUpdateParams{}

// IntegrationUpdateParams struct for IntegrationUpdateParams
...
type _IntegrationUpdateParams IntegrationUpdateParams
...
func (o IntegrationUpdateParams) MarshalJSON() ([]byte, error) {
...
func (o IntegrationUpdateParams) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["config"] = o.Config
	return toSerialize, nil
}

func (o *IntegrationUpdateParams) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationUpdateParams := _IntegrationUpdateParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIntegrationUpdateParams)

	if err != nil {
		return err
	}

	*o = IntegrationUpdateParams(varIntegrationUpdateParams)

	return err
}

type NullableIntegrationUpdateParams struct {
	value *IntegrationUpdateParams
	isSet bool
}

func (v NullableIntegrationUpdateParams) Get() *IntegrationUpdateParams {
	return v.value
}

func (v *NullableIntegrationUpdateParams) Set(val *IntegrationUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationUpdateParams(val *IntegrationUpdateParams) *NullableIntegrationUpdateParams {
	return &NullableIntegrationUpdateParams{value: val, isSet: true}
}

func (v NullableIntegrationUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
