...
// checks if the DomainSendingUpdateParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomainSendingUpdateParams{}

// DomainSendingUpdateParams Editable sending-domain settings (policy + default tracking).
type DomainSendingUpdateParams struct {
	DefaultTrackingDomainId NullableString `json:"defaultTrackingDomainId,omitempty"`
	Policy *DomainSendingPolicyParams `json:"policy,omitempty"`
}
...
func NewDomainSendingUpdateParams() *DomainSendingUpdateParams {
	this := DomainSendingUpdateParams{}
	return &this
}
...
func (o *DomainSendingUpdateParams) SetDefaultTrackingDomainIdNil() {
...
func (o *DomainSendingUpdateParams) GetPolicy() DomainSendingPolicyParams {
	if o == nil || IsNil(o.Policy) {
		var ret DomainSendingPolicyParams
		return ret
	}
	return *o.Policy
}
...
// SetPolicy gets a reference to the given DomainSendingPolicyParams and assigns it to the Policy field.
func (o *DomainSendingUpdateParams) SetPolicy(v DomainSendingPolicyParams) {
	o.Policy = &v
}

func (o DomainSendingUpdateParams) MarshalJSON() ([]byte, error) {
...
func (o DomainSendingUpdateParams) ToMap() (map[string]interface{}, error) {
...
type NullableDomainSendingUpdateParams struct {
	value *DomainSendingUpdateParams
	isSet bool
}

func (v NullableDomainSendingUpdateParams) Get() *DomainSendingUpdateParams {
	return v.value
}

func (v *NullableDomainSendingUpdateParams) Set(val *DomainSendingUpdateParams) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainSendingUpdateParams) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainSendingUpdateParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainSendingUpdateParams(val *DomainSendingUpdateParams) *NullableDomainSendingUpdateParams {
	return &NullableDomainSendingUpdateParams{value: val, isSet: true}
}

func (v NullableDomainSendingUpdateParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainSendingUpdateParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
