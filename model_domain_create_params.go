...
type DomainCreateParams struct {
	...
	Monitoring *DomainCreateParamsMonitoring `json:"monitoring,omitempty"`
	Tracking *DomainCreateParamsTracking `json:"tracking,omitempty"`
}
...
func (o *DomainCreateParams) GetMonitoring() DomainCreateParamsMonitoring {
	if o == nil || IsNil(o.Monitoring) {
		var ret DomainCreateParamsMonitoring
		return ret
	}
	return *o.Monitoring
}
...
// SetMonitoring gets a reference to the given DomainCreateParamsMonitoring and assigns it to the Monitoring field.
...
func (o *DomainCreateParams) GetTracking() DomainCreateParamsTracking {
	if o == nil || IsNil(o.Tracking) {
		var ret DomainCreateParamsTracking
		return ret
	}
	return *o.Tracking
}
...
// SetTracking gets a reference to the given DomainCreateParamsTracking and assigns it to the Tracking field.
