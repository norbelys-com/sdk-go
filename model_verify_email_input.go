...
// checks if the VerifyEmailInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VerifyEmailInput{}

// VerifyEmailInput The request body for a synchronous email verification: one address to check.
type VerifyEmailInput struct {
	// The email address to verify.
	Email string `json:"email"`
}

type _VerifyEmailInput VerifyEmailInput
...
func (o VerifyEmailInput) MarshalJSON() ([]byte, error) {
...
func (o VerifyEmailInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["email"] = o.Email
	return toSerialize, nil
}

func (o *VerifyEmailInput) UnmarshalJSON(data []byte) (err error) {
	...
	varVerifyEmailInput := _VerifyEmailInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVerifyEmailInput)

	if err != nil {
		return err
	}

	*o = VerifyEmailInput(varVerifyEmailInput)

	return err
}

type NullableVerifyEmailInput struct {
	value *VerifyEmailInput
	isSet bool
}

func (v NullableVerifyEmailInput) Get() *VerifyEmailInput {
	return v.value
}

func (v *NullableVerifyEmailInput) Set(val *VerifyEmailInput) {
	v.value = val
	v.isSet = true
}

func (v NullableVerifyEmailInput) IsSet() bool {
	return v.isSet
}

func (v *NullableVerifyEmailInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVerifyEmailInput(val *VerifyEmailInput) *NullableVerifyEmailInput {
	return &NullableVerifyEmailInput{value: val, isSet: true}
}

func (v NullableVerifyEmailInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVerifyEmailInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
