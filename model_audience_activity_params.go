...
type AudienceActivityParams struct {
	...
	Link *AudienceActivityParamsLink `json:"link,omitempty"`
...
func (o *AudienceActivityParams) GetLink() AudienceActivityParamsLink {
	if o == nil || IsNil(o.Link) {
		var ret AudienceActivityParamsLink
		return ret
	}
	return *o.Link
}
...
// SetLink gets a reference to the given AudienceActivityParamsLink and assigns it to the Link field.
