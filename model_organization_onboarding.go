...
// checks if the OrganizationOnboarding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationOnboarding{}

// OrganizationOnboarding Onboarding completion state.
type OrganizationOnboarding struct {
	// Whether onboarding has been completed.
	Completed bool `json:"completed"`
	CompletedAt NullableFloat32 `json:"completedAt"`
}

type _OrganizationOnboarding OrganizationOnboarding
...
func (o OrganizationOnboarding) MarshalJSON() ([]byte, error) {
...
func (o OrganizationOnboarding) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationOnboarding) UnmarshalJSON(data []byte) (err error) {
	...
	varOrganizationOnboarding := _OrganizationOnboarding{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrganizationOnboarding)

	if err != nil {
		return err
	}

	*o = OrganizationOnboarding(varOrganizationOnboarding)

	return err
}

type NullableOrganizationOnboarding struct {
	value *OrganizationOnboarding
	isSet bool
}

func (v NullableOrganizationOnboarding) Get() *OrganizationOnboarding {
	return v.value
}

func (v *NullableOrganizationOnboarding) Set(val *OrganizationOnboarding) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationOnboarding) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationOnboarding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationOnboarding(val *OrganizationOnboarding) *NullableOrganizationOnboarding {
	return &NullableOrganizationOnboarding{value: val, isSet: true}
}

func (v NullableOrganizationOnboarding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationOnboarding) UnmarshalJSON(src []byte) error {
	v.isSet = true
