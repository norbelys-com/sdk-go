...
type _IntegrationOptions IntegrationOptions
...
func (o *IntegrationOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationOptions := _IntegrationOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIntegrationOptions)

	if err != nil {
		return err
	}

	*o = IntegrationOptions(varIntegrationOptions)
