...
type ProgramVariantInput struct {
	Content *ProgramVariantInputContent `json:"content,omitempty"`
...
func (o *ProgramVariantInput) GetContent() ProgramVariantInputContent {
	if o == nil || IsNil(o.Content) {
		var ret ProgramVariantInputContent
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given ProgramVariantInputContent and assigns it to the Content field.
