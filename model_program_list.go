...
// checks if the ProgramList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProgramList{}
...
func (o ProgramList) ToMap() (map[string]interface{}, error) {
...
func (o *ProgramList) UnmarshalJSON(data []byte) (err error) {
	...
	varProgramList := _ProgramList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProgramList)

	if err != nil {
		return err
	}

	*o = ProgramList(varProgramList)

	return err
}

type NullableProgramList struct {
	value *ProgramList
	isSet bool
}

func (v NullableProgramList) Get() *ProgramList {
	return v.value
}

func (v *NullableProgramList) Set(val *ProgramList) {
	v.value = val
	v.isSet = true
}

func (v NullableProgramList) IsSet() bool {
	return v.isSet
}

func (v *NullableProgramList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProgramList(val *ProgramList) *NullableProgramList {
	return &NullableProgramList{value: val, isSet: true}
}

func (v NullableProgramList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProgramList) UnmarshalJSON(src []byte) error {
	v.isSet = true
