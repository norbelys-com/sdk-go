...
// checks if the SenderList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SenderList{}

// SenderList struct for SenderList
...
func (o SenderList) MarshalJSON() ([]byte, error) {
...
func (o SenderList) ToMap() (map[string]interface{}, error) {
...
func (o *SenderList) UnmarshalJSON(data []byte) (err error) {
	...
	varSenderList := _SenderList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSenderList)

	if err != nil {
		return err
	}

	*o = SenderList(varSenderList)

	return err
}

type NullableSenderList struct {
	value *SenderList
	isSet bool
}

func (v NullableSenderList) Get() *SenderList {
	return v.value
}

func (v *NullableSenderList) Set(val *SenderList) {
	v.value = val
	v.isSet = true
}

func (v NullableSenderList) IsSet() bool {
	return v.isSet
}

func (v *NullableSenderList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSenderList(val *SenderList) *NullableSenderList {
	return &NullableSenderList{value: val, isSet: true}
}

func (v NullableSenderList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSenderList) UnmarshalJSON(src []byte) error {
	v.isSet = true
