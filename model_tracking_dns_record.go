...
// checks if the TrackingDnsRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrackingDnsRecord{}

// TrackingDnsRecord The exact CNAME record to publish.
type TrackingDnsRecord struct {
	// The CNAME host to create.
	Host string `json:"host"`
	Type interface{} `json:"type"`
	// The CNAME target to point at.
	Value string `json:"value"`
}

type _TrackingDnsRecord TrackingDnsRecord
...
func (o TrackingDnsRecord) MarshalJSON() ([]byte, error) {
...
func (o TrackingDnsRecord) ToMap() (map[string]interface{}, error) {
...
func (o *TrackingDnsRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varTrackingDnsRecord := _TrackingDnsRecord{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTrackingDnsRecord)

	if err != nil {
		return err
	}

	*o = TrackingDnsRecord(varTrackingDnsRecord)

	return err
}

type NullableTrackingDnsRecord struct {
	value *TrackingDnsRecord
	isSet bool
}

func (v NullableTrackingDnsRecord) Get() *TrackingDnsRecord {
	return v.value
}

func (v *NullableTrackingDnsRecord) Set(val *TrackingDnsRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableTrackingDnsRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableTrackingDnsRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrackingDnsRecord(val *TrackingDnsRecord) *NullableTrackingDnsRecord {
	return &NullableTrackingDnsRecord{value: val, isSet: true}
}

func (v NullableTrackingDnsRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrackingDnsRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
