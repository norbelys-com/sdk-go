...
// checks if the DomainCreateParamsTracking type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomainCreateParamsTracking{}

// DomainCreateParamsTracking Tracking options (capability \"tracking\" only).
type DomainCreateParamsTracking struct {
...
func NewDomainCreateParamsTracking() *DomainCreateParamsTracking {
	this := DomainCreateParamsTracking{}
...
func (o DomainCreateParamsTracking) MarshalJSON() ([]byte, error) {
...
func (o DomainCreateParamsTracking) ToMap() (map[string]interface{}, error) {
...
type NullableDomainCreateParamsTracking struct {
	value *DomainCreateParamsTracking
	isSet bool
}

func (v NullableDomainCreateParamsTracking) Get() *DomainCreateParamsTracking {
	return v.value
}

func (v *NullableDomainCreateParamsTracking) Set(val *DomainCreateParamsTracking) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainCreateParamsTracking) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainCreateParamsTracking) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainCreateParamsTracking(val *DomainCreateParamsTracking) *NullableDomainCreateParamsTracking {
	return &NullableDomainCreateParamsTracking{value: val, isSet: true}
}

func (v NullableDomainCreateParamsTracking) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainCreateParamsTracking) UnmarshalJSON(src []byte) error {
	v.isSet = true
