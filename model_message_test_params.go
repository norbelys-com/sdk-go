...
// checks if the MessageTestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MessageTestParams{}

// MessageTestParams struct for MessageTestParams
type MessageTestParams struct {
...
type _MessageTestParams MessageTestParams
...
func (o MessageTestParams) MarshalJSON() ([]byte, error) {
...
func (o MessageTestParams) ToMap() (map[string]interface{}, error) {
...
func (o *MessageTestParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMessageTestParams := _MessageTestParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMessageTestParams)

	if err != nil {
		return err
	}

	*o = MessageTestParams(varMessageTestParams)

	return err
}

type NullableMessageTestParams struct {
	value *MessageTestParams
	isSet bool
}

func (v NullableMessageTestParams) Get() *MessageTestParams {
	return v.value
}

func (v *NullableMessageTestParams) Set(val *MessageTestParams) {
	v.value = val
	v.isSet = true
}

func (v NullableMessageTestParams) IsSet() bool {
	return v.isSet
}

func (v *NullableMessageTestParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMessageTestParams(val *MessageTestParams) *NullableMessageTestParams {
	return &NullableMessageTestParams{value: val, isSet: true}
}

func (v NullableMessageTestParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMessageTestParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
