...
// checks if the ProgramPauseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProgramPauseMeta{}

// ProgramPauseMeta struct for ProgramPauseMeta
type ProgramPauseMeta struct {
	// The measured rate that tripped the pause, as a percent.
	Rate float32 `json:"rate"`
	// The threshold it crossed, as a percent.
	Threshold float32 `json:"threshold"`
}

type _ProgramPauseMeta ProgramPauseMeta
...
func (o ProgramPauseMeta) MarshalJSON() ([]byte, error) {
...
func (o ProgramPauseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *ProgramPauseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varProgramPauseMeta := _ProgramPauseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProgramPauseMeta)

	if err != nil {
		return err
	}

	*o = ProgramPauseMeta(varProgramPauseMeta)

	return err
}

type NullableProgramPauseMeta struct {
	value *ProgramPauseMeta
	isSet bool
}

func (v NullableProgramPauseMeta) Get() *ProgramPauseMeta {
	return v.value
}

func (v *NullableProgramPauseMeta) Set(val *ProgramPauseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableProgramPauseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableProgramPauseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProgramPauseMeta(val *ProgramPauseMeta) *NullableProgramPauseMeta {
	return &NullableProgramPauseMeta{value: val, isSet: true}
}

func (v NullableProgramPauseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProgramPauseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
