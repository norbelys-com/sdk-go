...
// checks if the AudienceActivityLinkFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudienceActivityLinkFilter{}

// AudienceActivityLinkFilter For `clicked` only: narrow to clicks on a specific link (the destination URL).
type AudienceActivityLinkFilter struct {
	Op AudienceActivityLinkMatchOp `json:"op"`
	// The URL (or fragment) the click must match.
	Value string `json:"value"`
}

type _AudienceActivityLinkFilter AudienceActivityLinkFilter
...
func NewAudienceActivityLinkFilter(op AudienceActivityLinkMatchOp, value string) *AudienceActivityLinkFilter {
	this := AudienceActivityLinkFilter{}
	this.Op = op
	this.Value = value
	return &this
}
...
func (o AudienceActivityLinkFilter) MarshalJSON() ([]byte, error) {
...
func (o AudienceActivityLinkFilter) ToMap() (map[string]interface{}, error) {
...
func (o *AudienceActivityLinkFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varAudienceActivityLinkFilter := _AudienceActivityLinkFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAudienceActivityLinkFilter)

	if err != nil {
		return err
	}

	*o = AudienceActivityLinkFilter(varAudienceActivityLinkFilter)

	return err
}

type NullableAudienceActivityLinkFilter struct {
	value *AudienceActivityLinkFilter
	isSet bool
}

func (v NullableAudienceActivityLinkFilter) Get() *AudienceActivityLinkFilter {
	return v.value
}

func (v *NullableAudienceActivityLinkFilter) Set(val *AudienceActivityLinkFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAudienceActivityLinkFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAudienceActivityLinkFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAudienceActivityLinkFilter(val *AudienceActivityLinkFilter) *NullableAudienceActivityLinkFilter {
	return &NullableAudienceActivityLinkFilter{value: val, isSet: true}
}

func (v NullableAudienceActivityLinkFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAudienceActivityLinkFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
