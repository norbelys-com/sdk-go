...
func (r ApiAnalyticsQueryRequest) AnalyticsQuery(analyticsQuery AnalyticsQuery) ApiAnalyticsQueryRequest {
	r.analyticsQuery = &analyticsQuery
	return r
}
...
func (r ApiAnalyticsQueryRequest) IdempotencyKey(idempotencyKey string) ApiAnalyticsQueryRequest {
	r.idempotencyKey = &idempotencyKey
	return r
}

func (r ApiAnalyticsQueryRequest) Execute() (*AnalyticsQueryResult, *http.Response, error) {
	return r.ApiService.AnalyticsQueryExecute(r)
}

/*
AnalyticsQuery Run an analytics query
...
func (a *AnalyticsAPIService) AnalyticsQueryExecute(r ApiAnalyticsQueryRequest) (*AnalyticsQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AnalyticsQueryResult
	)
	...
	localVarPath := localBasePath + "/analytics/query"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.analyticsQuery == nil {
		return localVarReturnValue, nil, reportError("analyticsQuery is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.analyticsQuery
