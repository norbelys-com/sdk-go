...
func (r ApiFilesCreateRequest) Execute() (*FileObject, *http.Response, error) {
...
//  @return FileObject
func (a *FilesAPIService) FilesCreateExecute(r ApiFilesCreateRequest) (*FileObject, *http.Response, error) {
	var (
