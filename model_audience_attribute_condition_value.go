...
// AudienceAttributeConditionValue struct for AudienceAttributeConditionValue
type AudienceAttributeConditionValue struct {
...
func (dst *AudienceAttributeConditionValue) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(AudienceAttributeConditionValue)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *AudienceAttributeConditionValue) MarshalJSON() ([]byte, error) {
...
type NullableAudienceAttributeConditionValue struct {
	value *AudienceAttributeConditionValue
	isSet bool
}

func (v NullableAudienceAttributeConditionValue) Get() *AudienceAttributeConditionValue {
	return v.value
}

func (v *NullableAudienceAttributeConditionValue) Set(val *AudienceAttributeConditionValue) {
	v.value = val
	v.isSet = true
}

func (v NullableAudienceAttributeConditionValue) IsSet() bool {
	return v.isSet
}

func (v *NullableAudienceAttributeConditionValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAudienceAttributeConditionValue(val *AudienceAttributeConditionValue) *NullableAudienceAttributeConditionValue {
	return &NullableAudienceAttributeConditionValue{value: val, isSet: true}
}

func (v NullableAudienceAttributeConditionValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAudienceAttributeConditionValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
