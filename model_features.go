...
// Features Feature flags for your organization, returned by GET /v1/organization/features. Each key is a boolean: true if that feature is enabled for you, false if not.
type Features struct {
	// Whether this organization can connect email senders via Google OAuth. Access is granted per organization. Example: true
	SenderGoogleOAuth bool `json:"senderGoogleOAuth"`
}
...
func NewFeatures(senderGoogleOAuth bool) *Features {
	this := Features{}
	this.SenderGoogleOAuth = senderGoogleOAuth
	return &this
}
...
// GetSenderGoogleOAuth returns the SenderGoogleOAuth field value
func (o *Features) GetSenderGoogleOAuth() bool {
	...
	return o.SenderGoogleOAuth
}

// GetSenderGoogleOAuthOk returns a tuple with the SenderGoogleOAuth field value
// and a boolean to check if the value has been set.
func (o *Features) GetSenderGoogleOAuthOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SenderGoogleOAuth, true
}

// SetSenderGoogleOAuth sets field value
func (o *Features) SetSenderGoogleOAuth(v bool) {
	o.SenderGoogleOAuth = v
}
...
func (o Features) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["senderGoogleOAuth"] = o.SenderGoogleOAuth
...
func (o *Features) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varFeatures)
