...
// checks if the SenderWarmupStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SenderWarmupStatus{}

// SenderWarmupStatus Expansion: warmup status (present when expand[]=warmup).
type SenderWarmupStatus struct {
	Runtime NullableWarmupRuntimeStatus `json:"runtime"`
	Settings NullableWarmupSettings `json:"settings"`
}

type _SenderWarmupStatus SenderWarmupStatus
...
func (o SenderWarmupStatus) MarshalJSON() ([]byte, error) {
...
func (o SenderWarmupStatus) ToMap() (map[string]interface{}, error) {
...
func (o *SenderWarmupStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varSenderWarmupStatus := _SenderWarmupStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSenderWarmupStatus)

	if err != nil {
		return err
	}

	*o = SenderWarmupStatus(varSenderWarmupStatus)

	return err
}

type NullableSenderWarmupStatus struct {
	value *SenderWarmupStatus
	isSet bool
}

func (v NullableSenderWarmupStatus) Get() *SenderWarmupStatus {
	return v.value
}

func (v *NullableSenderWarmupStatus) Set(val *SenderWarmupStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSenderWarmupStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSenderWarmupStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSenderWarmupStatus(val *SenderWarmupStatus) *NullableSenderWarmupStatus {
	return &NullableSenderWarmupStatus{value: val, isSet: true}
}

func (v NullableSenderWarmupStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSenderWarmupStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
