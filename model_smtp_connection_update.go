...
// checks if the SmtpConnectionUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmtpConnectionUpdate{}

// SmtpConnectionUpdate SMTP server settings and credentials to update.
type SmtpConnectionUpdate struct {
	// The server hostname.
...
func (o SmtpConnectionUpdate) MarshalJSON() ([]byte, error) {
...
func (o SmtpConnectionUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableSmtpConnectionUpdate struct {
	value *SmtpConnectionUpdate
	isSet bool
}

func (v NullableSmtpConnectionUpdate) Get() *SmtpConnectionUpdate {
	return v.value
}

func (v *NullableSmtpConnectionUpdate) Set(val *SmtpConnectionUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableSmtpConnectionUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableSmtpConnectionUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmtpConnectionUpdate(val *SmtpConnectionUpdate) *NullableSmtpConnectionUpdate {
	return &NullableSmtpConnectionUpdate{value: val, isSet: true}
}

func (v NullableSmtpConnectionUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmtpConnectionUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
