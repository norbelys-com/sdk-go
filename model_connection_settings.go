...
// checks if the ConnectionSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionSettings{}

// ConnectionSettings IMAP server replies and warmup mail are read from (reuses the SMTP credentials).
...
type _ConnectionSettings ConnectionSettings
...
func (o ConnectionSettings) MarshalJSON() ([]byte, error) {
...
func (o ConnectionSettings) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectionSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varConnectionSettings := _ConnectionSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConnectionSettings)

	if err != nil {
		return err
	}

	*o = ConnectionSettings(varConnectionSettings)

	return err
}

type NullableConnectionSettings struct {
	value *ConnectionSettings
	isSet bool
}

func (v NullableConnectionSettings) Get() *ConnectionSettings {
	return v.value
}

func (v *NullableConnectionSettings) Set(val *ConnectionSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectionSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectionSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectionSettings(val *ConnectionSettings) *NullableConnectionSettings {
	return &NullableConnectionSettings{value: val, isSet: true}
}

func (v NullableConnectionSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectionSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
