...
// checks if the PersonErased type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PersonErased{}

// PersonErased struct for PersonErased
type PersonErased struct {
	Erased interface{} `json:"erased"`
	// The erased person's id.
	Id string `json:"id"`
}

type _PersonErased PersonErased

// NewPersonErased instantiates a new PersonErased object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPersonErased(erased interface{}, id string) *PersonErased {
	this := PersonErased{}
	this.Erased = erased
	this.Id = id
	return &this
...
// NewPersonErasedWithDefaults instantiates a new PersonErased object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPersonErasedWithDefaults() *PersonErased {
	this := PersonErased{}
	return &this
}
...
func (o *PersonErased) GetErased() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *PersonErased) GetErasedOk() (*interface{}, bool) {
...
func (o *PersonErased) SetErased(v interface{}) {
	o.Erased = v
}

// GetId returns the Id field value
func (o *PersonErased) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PersonErased) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *PersonErased) SetId(v string) {
	o.Id = v
}

func (o PersonErased) MarshalJSON() ([]byte, error) {
...
func (o PersonErased) ToMap() (map[string]interface{}, error) {
...
func (o *PersonErased) UnmarshalJSON(data []byte) (err error) {
	...
	varPersonErased := _PersonErased{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPersonErased)

	if err != nil {
		return err
	}

	*o = PersonErased(varPersonErased)

	return err
}

type NullablePersonErased struct {
	value *PersonErased
	isSet bool
}

func (v NullablePersonErased) Get() *PersonErased {
	return v.value
}

func (v *NullablePersonErased) Set(val *PersonErased) {
	v.value = val
	v.isSet = true
}

func (v NullablePersonErased) IsSet() bool {
	return v.isSet
}

func (v *NullablePersonErased) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePersonErased(val *PersonErased) *NullablePersonErased {
	return &NullablePersonErased{value: val, isSet: true}
}

func (v NullablePersonErased) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePersonErased) UnmarshalJSON(src []byte) error {
	v.isSet = true
