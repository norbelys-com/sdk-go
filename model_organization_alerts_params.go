...
// checks if the OrganizationAlertsParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationAlertsParams{}

// OrganizationAlertsParams Notification preferences to update.
type OrganizationAlertsParams struct {
	// Turn the deliverability alert email on/off.
	Deliverability *bool `json:"deliverability,omitempty"`
}

// NewOrganizationAlertsParams instantiates a new OrganizationAlertsParams object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOrganizationAlertsParams() *OrganizationAlertsParams {
	this := OrganizationAlertsParams{}
	return &this
}

// NewOrganizationAlertsParamsWithDefaults instantiates a new OrganizationAlertsParams object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOrganizationAlertsParamsWithDefaults() *OrganizationAlertsParams {
	this := OrganizationAlertsParams{}
	return &this
}

// GetDeliverability returns the Deliverability field value if set, zero value otherwise.
func (o *OrganizationAlertsParams) GetDeliverability() bool {
...
func (o *OrganizationAlertsParams) GetDeliverabilityOk() (*bool, bool) {
	if o == nil || IsNil(o.Deliverability) {
		return nil, false
	}
...
func (o *OrganizationAlertsParams) HasDeliverability() bool {
	if o != nil && !IsNil(o.Deliverability) {
		return true
	}
...
func (o *OrganizationAlertsParams) SetDeliverability(v bool) {
	o.Deliverability = &v
}

func (o OrganizationAlertsParams) MarshalJSON() ([]byte, error) {
...
func (o OrganizationAlertsParams) ToMap() (map[string]interface{}, error) {
...
type NullableOrganizationAlertsParams struct {
	value *OrganizationAlertsParams
	isSet bool
}

func (v NullableOrganizationAlertsParams) Get() *OrganizationAlertsParams {
	return v.value
}

func (v *NullableOrganizationAlertsParams) Set(val *OrganizationAlertsParams) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationAlertsParams) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationAlertsParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationAlertsParams(val *OrganizationAlertsParams) *NullableOrganizationAlertsParams {
	return &NullableOrganizationAlertsParams{value: val, isSet: true}
}

func (v NullableOrganizationAlertsParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationAlertsParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
