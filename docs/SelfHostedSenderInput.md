...
### NewSelfHostedSenderInputWithDefaults
...
`func (o *SelfHostedSenderInput) SetTransportModeNil(b bool)`

 SetTransportModeNil sets the value for TransportMode to be an explicit nil

### UnsetTransportMode
`func (o *SelfHostedSenderInput) UnsetTransportMode()`
