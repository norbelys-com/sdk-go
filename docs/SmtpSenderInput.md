...
`func NewSmtpSenderInput(fromEmail string, fromName string, smtp SmtpConnectionSettings, transportMode interface{}, ) *SmtpSenderInput`

NewSmtpSenderInput instantiates a new SmtpSenderInput object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewSmtpSenderInputWithDefaults

`func NewSmtpSenderInputWithDefaults() *SmtpSenderInput`

NewSmtpSenderInputWithDefaults instantiates a new SmtpSenderInput object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetBccCrmEmail

`func (o *SmtpSenderInput) GetBccCrmEmail() string`

GetBccCrmEmail returns the BccCrmEmail field if non-nil, zero value otherwise.

### GetBccCrmEmailOk

`func (o *SmtpSenderInput) GetBccCrmEmailOk() (*string, bool)`
...
`func (o *SmtpSenderInput) SetDailyLimit(v int32)`

SetDailyLimit sets DailyLimit field to given value.

### HasDailyLimit

`func (o *SmtpSenderInput) HasDailyLimit() bool`

HasDailyLimit returns a boolean if a field has been set.

### GetMinGapMinutes

`func (o *SmtpSenderInput) GetMinGapMinutes() int32`

GetMinGapMinutes returns the MinGapMinutes field if non-nil, zero value otherwise.

### GetMinGapMinutesOk

`func (o *SmtpSenderInput) GetMinGapMinutesOk() (*int32, bool)`
...
`func (o *SmtpSenderInput) SetMinGapMinutes(v int32)`

SetMinGapMinutes sets MinGapMinutes field to given value.

### HasMinGapMinutes

`func (o *SmtpSenderInput) HasMinGapMinutes() bool`

HasMinGapMinutes returns a boolean if a field has been set.

### GetReplyTo

`func (o *SmtpSenderInput) GetReplyTo() string`

GetReplyTo returns the ReplyTo field if non-nil, zero value otherwise.

### GetReplyToOk

`func (o *SmtpSenderInput) GetReplyToOk() (*string, bool)`
...
`func (o *SmtpSenderInput) SetReplyTo(v string)`

SetReplyTo sets ReplyTo field to given value.

### HasReplyTo

`func (o *SmtpSenderInput) HasReplyTo() bool`

HasReplyTo returns a boolean if a field has been set.

### GetSendingDomainId

`func (o *SmtpSenderInput) GetSendingDomainId() string`

GetSendingDomainId returns the SendingDomainId field if non-nil, zero value otherwise.

### GetSendingDomainIdOk

`func (o *SmtpSenderInput) GetSendingDomainIdOk() (*string, bool)`
...
`func (o *SmtpSenderInput) SetSignatureHtml(v string)`

SetSignatureHtml sets SignatureHtml field to given value.

### HasSignatureHtml

`func (o *SmtpSenderInput) HasSignatureHtml() bool`

HasSignatureHtml returns a boolean if a field has been set.

### GetFromEmail

`func (o *SmtpSenderInput) GetFromEmail() string`

GetFromEmail returns the FromEmail field if non-nil, zero value otherwise.

### GetFromEmailOk

`func (o *SmtpSenderInput) GetFromEmailOk() (*string, bool)`
...
`func (o *SmtpSenderInput) SetFromEmail(v string)`
...
`func (o *SmtpSenderInput) GetFromName() string`

GetFromName returns the FromName field if non-nil, zero value otherwise.

### GetFromNameOk

`func (o *SmtpSenderInput) GetFromNameOk() (*string, bool)`
...
`func (o *SmtpSenderInput) SetFromName(v string)`
...
`func (o *SmtpSenderInput) GetImap() SmtpSenderInputImap`

GetImap returns the Imap field if non-nil, zero value otherwise.

### GetImapOk

`func (o *SmtpSenderInput) GetImapOk() (*SmtpSenderInputImap, bool)`
...
`func (o *SmtpSenderInput) SetImap(v SmtpSenderInputImap)`

SetImap sets Imap field to given value.

### HasImap

`func (o *SmtpSenderInput) HasImap() bool`

HasImap returns a boolean if a field has been set.

### GetSmtp

`func (o *SmtpSenderInput) GetSmtp() SmtpConnectionSettings`

GetSmtp returns the Smtp field if non-nil, zero value otherwise.

### GetSmtpOk

`func (o *SmtpSenderInput) GetSmtpOk() (*SmtpConnectionSettings, bool)`
...
`func (o *SmtpSenderInput) SetSmtp(v SmtpConnectionSettings)`
...
`func (o *SmtpSenderInput) GetTransportMode() interface{}`

GetTransportMode returns the TransportMode field if non-nil, zero value otherwise.

### GetTransportModeOk

`func (o *SmtpSenderInput) GetTransportModeOk() (*interface{}, bool)`
...
`func (o *SmtpSenderInput) SetTransportMode(v interface{})`
...
`func (o *SmtpSenderInput) SetTransportModeNil(b bool)`

 SetTransportModeNil sets the value for TransportMode to be an explicit nil

### UnsetTransportMode
`func (o *SmtpSenderInput) UnsetTransportMode()`
