...
**TransportProvider** | Pointer to **string** | The voice provider key. | [optional] 

## Methods

### NewVoiceSenderInput

`func NewVoiceSenderInput(fromEmail string, fromName string, transportMode interface{}, ) *VoiceSenderInput`

NewVoiceSenderInput instantiates a new VoiceSenderInput object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewVoiceSenderInputWithDefaults

`func NewVoiceSenderInputWithDefaults() *VoiceSenderInput`

NewVoiceSenderInputWithDefaults instantiates a new VoiceSenderInput object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetBccCrmEmail

`func (o *VoiceSenderInput) GetBccCrmEmail() string`

GetBccCrmEmail returns the BccCrmEmail field if non-nil, zero value otherwise.

### GetBccCrmEmailOk

`func (o *VoiceSenderInput) GetBccCrmEmailOk() (*string, bool)`
...
`func (o *VoiceSenderInput) SetBccCrmEmail(v string)`

SetBccCrmEmail sets BccCrmEmail field to given value.

### HasBccCrmEmail

`func (o *VoiceSenderInput) HasBccCrmEmail() bool`

HasBccCrmEmail returns a boolean if a field has been set.

### GetClientLabel

`func (o *VoiceSenderInput) GetClientLabel() string`

GetClientLabel returns the ClientLabel field if non-nil, zero value otherwise.

### GetClientLabelOk

`func (o *VoiceSenderInput) GetClientLabelOk() (*string, bool)`
...
`func (o *VoiceSenderInput) SetClientLabel(v string)`

SetClientLabel sets ClientLabel field to given value.

### HasClientLabel

`func (o *VoiceSenderInput) HasClientLabel() bool`

HasClientLabel returns a boolean if a field has been set.

### GetDailyLimit

`func (o *VoiceSenderInput) GetDailyLimit() int32`

GetDailyLimit returns the DailyLimit field if non-nil, zero value otherwise.

### GetDailyLimitOk

`func (o *VoiceSenderInput) GetDailyLimitOk() (*int32, bool)`
...
`func (o *VoiceSenderInput) SetDailyLimit(v int32)`

SetDailyLimit sets DailyLimit field to given value.

### HasDailyLimit

`func (o *VoiceSenderInput) HasDailyLimit() bool`

HasDailyLimit returns a boolean if a field has been set.

### GetMinGapMinutes

`func (o *VoiceSenderInput) GetMinGapMinutes() int32`

GetMinGapMinutes returns the MinGapMinutes field if non-nil, zero value otherwise.

### GetMinGapMinutesOk

`func (o *VoiceSenderInput) GetMinGapMinutesOk() (*int32, bool)`
...
`func (o *VoiceSenderInput) SetMinGapMinutes(v int32)`

SetMinGapMinutes sets MinGapMinutes field to given value.

### HasMinGapMinutes

`func (o *VoiceSenderInput) HasMinGapMinutes() bool`

HasMinGapMinutes returns a boolean if a field has been set.

### GetReplyTo

`func (o *VoiceSenderInput) GetReplyTo() string`

GetReplyTo returns the ReplyTo field if non-nil, zero value otherwise.

### GetReplyToOk

`func (o *VoiceSenderInput) GetReplyToOk() (*string, bool)`
...
`func (o *VoiceSenderInput) SetReplyTo(v string)`

SetReplyTo sets ReplyTo field to given value.

### HasReplyTo

`func (o *VoiceSenderInput) HasReplyTo() bool`

HasReplyTo returns a boolean if a field has been set.

### GetSendingDomainId

`func (o *VoiceSenderInput) GetSendingDomainId() string`

GetSendingDomainId returns the SendingDomainId field if non-nil, zero value otherwise.

### GetSendingDomainIdOk

`func (o *VoiceSenderInput) GetSendingDomainIdOk() (*string, bool)`
...
`func (o *VoiceSenderInput) SetSignatureHtml(v string)`

SetSignatureHtml sets SignatureHtml field to given value.

### HasSignatureHtml

`func (o *VoiceSenderInput) HasSignatureHtml() bool`

HasSignatureHtml returns a boolean if a field has been set.

### GetFromEmail

`func (o *VoiceSenderInput) GetFromEmail() string`

GetFromEmail returns the FromEmail field if non-nil, zero value otherwise.

### GetFromEmailOk

`func (o *VoiceSenderInput) GetFromEmailOk() (*string, bool)`
...
`func (o *VoiceSenderInput) SetFromEmail(v string)`
...
`func (o *VoiceSenderInput) GetFromName() string`

GetFromName returns the FromName field if non-nil, zero value otherwise.

### GetFromNameOk

`func (o *VoiceSenderInput) GetFromNameOk() (*string, bool)`
...
`func (o *VoiceSenderInput) SetFromName(v string)`
...
`func (o *VoiceSenderInput) GetTransportMode() interface{}`

GetTransportMode returns the TransportMode field if non-nil, zero value otherwise.

### GetTransportModeOk

`func (o *VoiceSenderInput) GetTransportModeOk() (*interface{}, bool)`
...
`func (o *VoiceSenderInput) SetTransportMode(v interface{})`
...
`func (o *VoiceSenderInput) SetTransportProvider(v string)`

SetTransportProvider sets TransportProvider field to given value.

### HasTransportProvider

`func (o *VoiceSenderInput) HasTransportProvider() bool`
